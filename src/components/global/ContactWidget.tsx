        ...
        {success ? (
          ...
          <form className="mt-6 space-y-4" onSubmit={send}>
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="button" onClick={() => window.open(`mailto:${userConfig.contact.email}`, '_blank')} className="text-sm text-gray-300 hover:text-white underline underline-offset-2">Email me directly</button>
            </div>
          </form>
        )}
      </div>
