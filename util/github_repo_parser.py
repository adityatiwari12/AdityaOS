...
def main():
    ...
    project_json = parser.create_project_json(
        owner='adityatiwari12', #dont forget to change this to your github username
        ...
        description='An interactive macOS-style portfolio website with sections for experience, research, projects, skills, certifications, and more. Built with Astro.js, Tailwind CSS, TypeScript, React, and Vercel.', #dont forget to change this to your project description
        repo_url='https://github.com/adityatiwari12/portfolio', #dont forget to change this to your github repo url
        live_url='https://adityatiwari.vercel.app', #dont forget to change this to your live website url or leave it blank if you dont have one
